...
async def delete_transferred_callee_dialog_profile(
    ...
    Decreases counter values for the transferred callee profile and deletes the dialog
    from the local database.
    :param bundle:
    :return:
    """
...
async def delete_transferred_caller_dialog_profile(
    ...
    Decreases counter values for the transferred caller profile and deletes the dialog
    from the local database.
    :param bundle:
    :return:
    """
...
async def delete_huntgroup_member_dialog_profile(
    ...
    Decreases counter values for the huntgroup member profile and deletes the dialog
    from the local database.
    :param bundle:
    :return:
    """
